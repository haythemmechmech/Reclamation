...
public class ActionResource {
    ...
    @GetMapping("/actions")
    @Timed
    public List<Action> getAllActions(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
        log.debug("REST request to get all Actions");
        return actionRepository.findAllWithEagerRelationships();
    }
    ...
    public ResponseEntity<Action> getAction(@PathVariable Long id) {
        ...
        Optional<Action> action = actionRepository.findOneWithEagerRelationships(id);
