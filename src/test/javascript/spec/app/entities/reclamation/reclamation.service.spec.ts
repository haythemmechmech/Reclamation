    ...
    describe('Reclamation Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/reclamations';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Reclamation', () => {
                service.create(new Reclamation(null)).subscribe(received => {
            ...
            it('should update a Reclamation', () => {
                service.update(new Reclamation(123)).subscribe(received => {
            ...
            it('should return a Reclamation', () => {
